...
class EcoleController extends Controller
{
    ...
    public function singleAction($slug)
    {
        ...
        //if($slug == 'cure-mercure' || $slug == 'la-polyvalente-des-monts' || $slug == 'ecole-secondaire-poly-jeunesse') {
        if($slug == 'cure-mercure' ||  $slug == 'la-polyvalente-des-monts' || $slug == 'augustin-norbert-morin' || $slug == 'emilien-frenette' || $slug == 'la-foret' || $slug == 'polyvalente-st-jerome' || $slug == 'ecole-secondaire-henri-dunant' || $slug == 'ecole-secondaire-le-tremplin' || $slug == 'ecole-secondaire-de-mirabel' || $slug == 'ecole-secondaire-du-harfang' || $slug == 'polyvalente-deux-montagnes' || $slug == 'ecole-secondaire-du-marechal' || $slug == 'liberte-jeunesse') {
            $articles = $articlesRepository->findAllbyEcoleDate($ecole[0]->getId(),'2025');
        } elseif($slug == 'cap-jeunesse' || $slug == 'ecole-secondaire-la-source') {
            
            $articles = $articlesRepository->findAllbyEcoleDate($ecole[0]->getId(),'2024');
        } else {    
    ...
    public function articlescategorieAction(Request $request, $slug, $categorie_id)
    {
        ...
        $articles = $articlesRepository->findAllbyEcoleCategorie($categorie_id, $ecole[0]->getId());
