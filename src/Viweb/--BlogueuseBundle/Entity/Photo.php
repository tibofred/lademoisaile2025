...
/**
 * @ORM\Table(name="blogueuse_photo")
 * @ORM\Entity
...
class Photo
{
 ...
 // On ajoute cet attribut pour y stocker le nom du fichier temporairement
  ...
  public function upload()
  {
    ...
    $file_avatar = $this->getUploadRootDir().'/avatar/'.$this->id.'.'.$this->url;
    $file_mini = $this->getUploadRootDir().'/mini/'.$this->id.'.'.$this->url;

    //$this->resize_image($file_up, 95 , 1000, $file_mini, $this->url);
    $this->resize_crop_image($file_up, $file_avatar, 87 , 87);
    $this->resize_crop_image($file_up, $file_mini, 328 , 328);
 ...
 public function getUploadDir()
  {
    ...
    return 'uploads/photos-blogueuses';
  }
