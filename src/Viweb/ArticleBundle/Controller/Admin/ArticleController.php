        ...
        if (in_array("ROLE_ADMIN", $roles)) {
            ...
            if(sizeof($ecoles)>0) {
                foreach($ecoles as $ecole)  {
                    ...
                    $ecole->articles = $articlesRepository->findAllbyEcoleNoDate($ecole);
                    $eco_articles[] = $ecole;
                }

            }
            return $this->render('@ViwebArticle/Article/Admin/articles_ecoles.html.twig', array(
                'ecoles' => $eco_articles
            ));
        } else { 
            $articlesRepository = $this
            ...
            $articles = $articlesRepository->findAllbyEcoleNoDate($user->getEcole());
        }
