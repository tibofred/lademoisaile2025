...
class Page extends FullSEO
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SiteBundle\Entity\Page", inversedBy="childs")
    ...
    /**
     * @ORM\OneToMany(targetEntity="SiteBundle\Entity\Page", mappedBy="parent")
     */
    private $childs;
     ...
     * Add child.
     *
     * @param \SiteBundle\Entity\Page $child
     *
     * @return Page
     */
    public function addChild(\SiteBundle\Entity\Page $child)
    {
        $this->childs[] = $child;
     ...
     */
    public function removeChild(\SiteBundle\Entity\Page $child)
    {
